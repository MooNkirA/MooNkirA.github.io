...
- [鱼皮AI导航](https://ai.codefather.cn/)
- [Claude Code 中文教程](https://claude.aigcbaba.com/) - 面向中文用户的 Claude Code 喂饭级使用指南。这是一套 Claude Code中文教程，聚焦安装配置、国内大模型接入、cc switch、Plan Mode、权限模式、CLAUDE.md 记忆、Skills、Hooks、MCP、Subagents 和实战案例。学习重点不是手敲命令，而是把目标、范围、验收和风险说清楚，让 CC 把开发任务做成可控交付。
- [Codex 中文教程](https://codex.aigcbaba.com/) - 面向中文用户的 OpenAI Codex 实战学习网站。这是一套围绕真实工作流整理的 Codex 中文教程。重点不是背几句提示词，而是把目标、范围、风险、 验收和协作讲清楚，让 Codex 真正帮你把任务做成可控、可检查、可交付的结果。
- [AI进阶之路](https://ai.javabetter.cn/) 系统掌握 Claude Code 与 Codex 从安装配置、核心概念到 MCP、Skill、Hook、Agent SDK 与实战工作流。
- [JavaGuide | AI 应用开发知识体系](https://javaguide.cn/ai/) - 大模型、Agent、RAG、MCP、Prompt 工程与系统设计
- [JavaGuide | AI 编程实战指南](https://javaguide.cn/ai-coding/) - Claude Code、Cursor、Codex、Trae 使用技巧与面试题

### 综合类编程文档/博客

- [JavaGuide](https://javaguide.cn/) - Java 面试与后端知识体系，覆盖计算机基础、数据库、分布式、高并发、系统设计与 AI 应用开发
...
- [潘志的技术笔记](https://pzblog.cn/) - 一份涵盖 Java、JVM、SpringBoot、SpringCloud 等核心技术知识笔记
...
- [小林简历](https://jianli.xiaolinnote.com/) - 目前网站完全免费！无水印！支持 PDF 导出！
