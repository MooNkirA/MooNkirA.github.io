...
<span style="color: red;">**monitorexit 插入在方法结束处和异常处，JVM 保证每个 monitorenter 必须有对应的 monitorexit，确保释放锁。**</span>
...
当一个线程尝试访问 `synchronized` 修饰的代码块时，它首先要获得锁，<span style="color: red;">**这个锁是存在锁对象的对象头中的**</span>。
...
<span style="color: red;">**更底层是读写变量时使用 lock 指令来多核 CPU 之间的可见性与有序性**</span>
...
## (待学习研究)ScheduledThreadPoolExecutor 源码解析
