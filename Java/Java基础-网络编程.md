...
<span style="color: red;">**网络通讯三要素小结：通过IP找主机，通过端口找程序，通过协议确定如何传输数据。**</span>
...
##### 第四次挥手时客户端 TIME_WAIT 状态为什么要等待 2MSL
