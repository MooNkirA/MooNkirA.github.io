...
- [[01-项目介绍与开发环境搭建|第01章 项目介绍与开发环境搭建]]
- [[02-前端环境搭建与短信校验注册功能|第02章 前端环境搭建与短信校验注册功能]]
- [[03-用户登陆与认证授权|第03章 用户登陆与认证授权]]
- [[04-分布式事务解决方案-Hmily|第04章 分布式事务解决方案-Hmily]]
- [[05-用户开户|第05章 用户开户]]
- [[06-分库分表解决方案-Sharding-JDBC|第06章 分库分表解决方案 Sharding-JDBC]]
- [[07-用户发标|第07章 用户发标]]
- [[08-标的检索|第08章 标的检索]]
- [[09-用户投标|第09章 用户投标]]
- [[10-投标放款|第10章 投标放款]]
...
- [[12-投标充值|第12章 投标充值]]
- [[13-还款提现|第13章 还款提现]]
- [[14-用户身份认证|第14章 用户身份认证]]
- [[15-项目部署|第15章 项目部署]]
- [[16-服务调用链路追踪|第16章 服务调用链路追踪]]
- [[17-Sentinel限流|第17章 Sentinel 限流]]
- [[18-Hystrix服务熔断|第18章 Hystrix 服务熔断]]
- [[19-项目总结|第19章 项目总结]]
