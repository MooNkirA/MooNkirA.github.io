...
> <span style="color: purple;">**Tips: 以上服务如果是在同一个注册中心时，可以通过 `serviceId` 来配置转发；但如果服务不在同一个注册中心时，则可以通过 `url` 来直接指定请求转发的请求地址**</span>
