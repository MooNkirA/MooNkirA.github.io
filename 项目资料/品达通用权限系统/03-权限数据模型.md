...
品达通用权限系统对外提供的功能中<span style="color: red;">**认证**</span>和<span style="color: red;">**鉴权**</span>是其核心功能，通过导入的初始工程可以发现其中有两个服务，即网关服务和权限服务。其中用户认证需要在权限服务中完成，鉴权需要在网关服务中完成。在实现此两个核心功能之前，必须明确认证和鉴权的整体执行流程。
