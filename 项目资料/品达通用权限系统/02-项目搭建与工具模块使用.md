...
<span style="color: red;">**特别注意：下面使用 `pd-tools-xxx` 的工具模块的示例，如果是非本项目引入时，需要将其安装到本地仓库**</span>
...
- <span style="color: red;">**关键步骤**</span>：创建配置类，在类中手动实例化监听器，传入具体日志实现的函数式接口
