...
#### DEPENDENT UNION、DEPENDENT SUBQUERY 类型
...
#### UNCACHEABLE SUBQUERY、UNCACHEABLE UNION 类型
...
### 单表查询的成本 - 基于成本的优化步骤（TODO mark: 待补充）
