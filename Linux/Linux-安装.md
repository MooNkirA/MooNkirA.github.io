## CentOS-7-x86_64-DVD-1804 版本的安装
...
> 注：上面可以选择开启【以太网(ens33)】，里面可以设置相关ip配置，这样就不需要在安装后再去修改<span style="color: red;">**ifcfg-ens33**</span>，文件也会比不开启时多出标识了主要修改部分的设置
