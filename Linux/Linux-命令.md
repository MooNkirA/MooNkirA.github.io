...
> Notes: <span style="color: red;">**命令名称、命令参数、命令对象之间使用空格键分隔。**</span>
...
> <span style="color: violet;">**开发中，如果需要查看命令参数，先使用 `man`，如果没有结果，再使用 `help`**</span>
...
linux 提供管道符号`|`，作用是『命令1』的输出内容，将作为『命令2』的输入内容。<span style="color: red;">**管道的核心就是两个命令中传递数据**</span>。
