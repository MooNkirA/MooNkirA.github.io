...
|  `required`   | true/false | 定义输入字段的值是否是必需的。 <span style="color: red;">**注：当使用类型：hidden, image, button, submit, reset 时无法使用**</span> |
|               |            |                                                                                                                       |
|               |            |                                                                                                                       |
|               |            |                                                                                                                       |
...
![](images/20190228230419926_28670.png)
